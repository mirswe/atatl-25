...
customer_info_agent = Agent(
    ...
    description=(
        ...
        "such as names, emails, phone numbers, addresses, reward points, previous orders, "
        "birthdays, interests, company information, or contact details. "
        "This agent handles customer profiles, contact information, purchase history, and customer-related data entry."
    ),
    instruction=(
        ...
        "- Carefully extract all available customer details (name, email, phone, rewardPoints, prevOrders, birthday, interests, address, company, category, notes)\n"
...
root_agent = Agent(
    ...
    instruction=(
        ...
        "1. customer_info_agent - For customer information including names, emails, phones, addresses, reward points, previous orders, birthdays, interests, company info, and contact details\n"
        ...
        "\n\n"
        "Decision guidelines:\n"
        "- If the prompt/files contain customer information (names, emails, phones, addresses, reward points, orders, birthdays, interests, contact info) → delegate to customer_info_agent\n"
